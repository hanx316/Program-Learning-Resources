...
- [Promises/A+](https://promisesaplus.com/)：ES6 采用的 Promises/A+ 规范，这里有一个[中译版本](http://www.ituring.com.cn/article/66566)
...
- [W3C SVG](https://www.w3.org/Graphics/SVG/)：W3C SVG 规范

- [MDN SVG 教程](https://developer.mozilla.org/en-US/docs/Web/SVG/Tutorial)：入门参考
...
- [D3.js 入门教程](http://wiki.jikexueyuan.com/project/d3wiki/)：不错的入门教程，但是适用的 d3 版本不是最新的
